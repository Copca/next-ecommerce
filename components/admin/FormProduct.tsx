/**
 * /page/admin/products/[slug] si slug=new -> para producto nuevo
 * /page/admin/products/[slug] si slug=cualquier_texto -> para editar producto
 */
...
export const FormProduct: FC<Props> = ({ product }) => {
	...
	const onFileSelected = async ({ target }: ChangeEvent<HTMLInputElement>) => {
		// target.files es un [] con información de los archivos
	...
	const onSubmitForm = async (form: FormData) => {
		...
		// Crear o editar producto 'POST' ó 'PUT'
		try {
			...
			if (!form._id) {
				//  Recargar el navegador (producto nuevo)
			...
			<div className='grid md:grid-cols-2 grid-flow-row-dense gap-6'>
				...
				<div className='row-span-3'>
					...
					<input
						...
						ref={fileInputRef}
						className='hidden'
						// onChange={(e) => onFileSelected(e)} es lo mismo que la siguente línea
